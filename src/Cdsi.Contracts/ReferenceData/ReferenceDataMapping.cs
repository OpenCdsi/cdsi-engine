...
/// <summary>Maps Cdsi.Core.ReferenceData's real models to this project's reference-data DTOs - kept as one small, testable static class rather than inlined into endpoint handlers, same reasoning as RequestMapping/ResponseMapping.</summary>
